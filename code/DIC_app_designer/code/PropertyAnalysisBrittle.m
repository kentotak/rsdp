% Code for stress-strain-match based on load file, time-image and results
% of displacement without determination of RP values (brittle materials)
% Programmed by Tobias and Benjamin, revised by Melanie
% Last revision: 04/28/16
function PropertyAnalysisBrittle
...
timeshift=strainstart-loadstart;
...
StrainStressAnalysisNoRP(final_plot, width, thickness, samplename);
