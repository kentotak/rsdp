...
function DP_equibiaxial(saving,seriesName,path,strainFile,scanDirection,pillarDiameter,stepSize,pillarRedFactor,xAxisData,xAxisLowLimit,xAxisHighLimit, ...
    ...
    %% Influence factors
    factors = 1; % 1 = unpublished code, 2 = generalised... code, 3 = nanoscale... paper
    switch factors
        case 1
            % Parameters from previously unpublished code (3rd degree polynomial)
    ...
    for i = 1:(length(normalizedDepth)-1)
        ...
        [~, sp, lower, upper, xplot] = linfitxy(reducedNormalizedDepth, reducedEps, reducedErrorNormalizedDepth, reducedErrorStrain, 'Verbosity', 0);
