...
## Installation
### System requirements
This application was developed on Windows 10 and Windows 11. No other operating system was used for testing.

### MATLAB requirements
This application was developed in MATLAB R2024a through R2025b. Given the recent efforts put by MATLAB into app development, it seems that the application will be functional in the foreseeable future.
